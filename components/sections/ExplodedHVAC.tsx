...
export default function ExplodedHVAC() {
  ...
  // Connecting beam opacity
  const beamOpacity = useTransform(scrollYProgress, [0.4, 0.6], [0, 1]);

  return (
    <section ref={containerRef} className="relative min-h-[150vh] md:min-h-[200vh] bg-ivory-alt py-24" data-nav-theme="light">
      <div className="sticky top-0 left-0 right-0 h-screen flex flex-col md:flex-row items-center justify-center overflow-hidden px-6 lg:px-12">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center max-w-lg mb-8 md:mb-0">
          <motion.div style={{ opacity }}>
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif text-navy mb-4 md:mb-6">
              Precision from the inside out.
            </h2>
            <p className="text-navy/60 font-sans font-light text-base md:text-lg leading-relaxed mb-6 md:mb-8">
        ...
        <div className="w-full md:w-1/2 flex items-center justify-center relative min-h-[300px] md:min-h-[500px]">
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="hidden md:flex absolute right-[-150px] items-center gap-3 w-40 text-navy"
              >
            ...
            <motion.div
              className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/3 w-[70%] h-[120px] sm:h-[160px] bg-navy border border-navy-light rounded-sm shadow-[0_0_50px_rgba(13,27,42,0.4)] flex items-center justify-center z-20 flex-col gap-2 p-3 sm:p-4"
            >
              ...
              <motion.div
                ...
                className="hidden md:flex absolute left-[-180px] items-center gap-3 w-48 text-navy flex-row-reverse"
              >
                  <div className="h-[1px] w-8 bg-terracotta" />
            ...
            <motion.div
              style={{ y: layer2Y }}
              className="absolute left-1/2 top-1/3 -translate-x-1/2 w-[75%] h-[50px] sm:h-[60px] bg-white border border-sand-light shadow-xl flex items-center px-3 sm:px-4 rounded-sm z-30"
            >
              ...
              <motion.div
                ...
                className="hidden md:flex absolute right-[-160px] items-center gap-3 w-40 text-navy"
              >
                  <div className="h-[1px] w-8 bg-terracotta" />
            ...
            <motion.div
              style={{ y: layer1Y }}
              className="absolute left-1/2 top-[10%] -translate-x-1/2 w-[80%] h-[80px] sm:h-[100px] bg-sand-light rounded-t-xl shadow-2xl border-t border-x border-white flex justify-center items-start pt-3 sm:pt-4 overflow-hidden z-40"
            >
              <div className="w-[80px] h-[80px] sm:w-[120px] sm:h-[120px] rounded-full border-[6px] sm:border-[8px] border-navy/10 flex items-center justify-center animate-[spin_4s_linear_infinite]">
              ...
              <motion.div
                ...
                className="hidden md:flex absolute left-[-160px] top-4 items-center gap-3 w-40 text-navy flex-row-reverse"
              >
                  <div className="h-[1px] w-8 bg-terracotta" />
          ...
          {/* Mobile-only labels below the diagram */}
          <motion.div
            style={{ opacity }}
          ...
          >
            {[
              ...
              <span key={label} className="flex items-center gap-1.5 text-[10px] font-sans font-bold uppercase tracking-wider text-navy/60">
